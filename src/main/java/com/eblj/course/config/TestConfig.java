...
import com.eblj.course.entities.Category;
import com.eblj.course.entities.Order;
import com.eblj.course.entities.OrderItem;
import com.eblj.course.entities.Payment;
import com.eblj.course.entities.Product;
import com.eblj.course.entities.User;
import com.eblj.course.entities.enuns.OrderStatus;
import com.eblj.course.repositories.CategoryRepository;
import com.eblj.course.repositories.OrderItemRepository;
import com.eblj.course.repositories.OrderRepository;
import com.eblj.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"),OrderStatus.WAINTING, u2);
		Order o3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"),OrderStatus.WAINTING, u1);
